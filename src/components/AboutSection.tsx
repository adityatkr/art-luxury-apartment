        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="rounded-3xl overflow-hidden aspect-[3/4] relative">
              <img src="/images/hotel-exterior.png" alt="Art: The Luxury Serviced Apartment" className="w-full h-full object-cover object-center" />
          ...
          >
            ...
            <p className="text-[#6B7280] text-[15px] leading-[1.85] mb-10">
              Our 32 spacious 1 BHK suites offer the rare combination of a fully equipped kitchen, separate living room, and hotel-grade service — making long stays genuinely comfortable.
            </p>
