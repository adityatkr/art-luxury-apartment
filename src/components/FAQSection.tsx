...
const faqs = [
  { q: "What makes Art: The Luxury Serviced Apartment a Japanese-friendly hotel?", a: "Our staff is trained to understand Japanese customs and provide attentive, Japanese-style hospitality. We have in-house Japanese cuisine at Arata restaurant, Japanese-speaking staff assistance, and accommodation designed for the comfort and preferences of Japanese guests." },
  ...
  { q: "Is the hotel suitable for long corporate stays?", a: "Absolutely — Art: The Luxury Serviced Apartment is specifically designed for long-stay corporate travelers and expat professionals. The 1 BHK layout with kitchen, living room, and workspace makes extended stays genuinely comfortable. Special long-stay packages are available on request." },
  { q: "How do I reach the hotel from the airport or metro?", a: "The hotel is located on Golf Course Road, Sector 27, Gurgaon. The nearest metro station is DLF Phase 1 on the Rapid Metro line (~5 minutes away). From IGI Airport, the hotel is approximately 30-40 minutes by road via NH-48." },
];
