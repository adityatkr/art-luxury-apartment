...
const faqs = [
  { q: "What makes Art: The Luxury Serviced Apartment a Japanese-friendly apartment?", a: "Our staff is trained to understand Japanese customs and provide attentive, Japanese-style hospitality. We have in-house Japanese cuisine at Arata restaurant, Japanese-speaking staff assistance, and accommodation designed for the comfort and preferences of Japanese guests." },
  ...
  { q: "Is the apartment suitable for long corporate stays?", a: "Absolutely — Art: The Luxury Serviced Apartment is specifically designed for long-stay corporate travelers and expat professionals. The 1 BHK layout with kitchen, living room, and workspace makes extended stays genuinely comfortable. Special long-stay packages are available on request." },
  { q: "How do I reach the apartment from the airport or metro?", a: "The apartment is located on Golf Course Road, Sector 27, Gurgaon. The nearest metro station is DLF Phase 1 on the Rapid Metro line (~5 minutes away). From IGI Airport, the apartment is approximately 30-40 minutes by road via NH-48." },
];
      ...
      <div className="max-w-[1280px] mx-auto px-8 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.6fr] gap-16 items-start">
          <div className="lg:sticky lg:top-28">
            <motion.p initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="section-label mb-4">FAQ</motion.p>
            ...
            <p className="text-[#9CA3AF] text-[13px] tracking-[0.1em] uppercase mb-6">Frequently Asked Questions</p>
            <p className="text-[15px] text-[#6B7280] leading-[1.75] mb-8">Everything you need to know about staying at Art: The Luxury Serviced Apartment.</p>
